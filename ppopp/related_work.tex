...
One way of achieving better automatic parallelisation is to use thread-level speculation (TLS) \cite{Rundberg01anall-software, gregory05stampede, welc05safe}.
