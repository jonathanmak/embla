...
Figure \ref{spec-data} shows the parallelism limits when considering dynamic data dependences compared to the baseline model of using static dependences.
