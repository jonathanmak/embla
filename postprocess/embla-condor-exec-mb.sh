...
SPREADSHEET=/home/jchm2/public_html/private/embla-mb.tsv
DATE=`date -u`
...
# Dynamic data deps, TLP, dynamic control deps, no early spawns, no loops
# Used for generating static deps file
FIRST_OPTS="--loop-file=/dev/null --trace-file=$TRACE_FILE_NOLOOP --edge-file=$EDGES_FILE_NOLOOP --draw --dwar --dwaw --dctl $CLIENT_PROG"
