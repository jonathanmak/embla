...
We present an extension of Embla, a Valgrind-based dependence profiler that links dynamic dependences back to source code, to be used as a tool to estimate and help realize inherent task-level parallelism in a sequential program.
