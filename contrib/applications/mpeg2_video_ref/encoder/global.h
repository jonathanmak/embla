...
/* 
 * Copyright (C) 1995, MPEG Software Simulation Group. All Rights Reserved. 
 *
 * Authors:   Stefan Eckart, Chad Fogg
 * Version:   1.1c    July 15, 1995
 *
 *
...
EXTERN char version[]
#ifdef GLOBAL
  ="mpeg2encode V1.1c, 95/07/15"
#endif
;

EXTERN char author[]
#ifdef GLOBAL
  ="(C) 1995, MPEG Software Simulation Group"
#endif
;
